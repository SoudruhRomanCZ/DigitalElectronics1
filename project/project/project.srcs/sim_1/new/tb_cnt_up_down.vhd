...
architecture testbench of tb_cnt_up_down is
  ...
  signal sig_m        : std_logic_vector(c_CNT_WIDTH - 1 downto 0);
  signal sig_h        : std_logic_vector(c_CNT_WIDTH - 1 downto 0);
...
begin
  ...
  begin
    ...
    while now < 1000000 ns loop             -- 75 periods of 100MHz clock
