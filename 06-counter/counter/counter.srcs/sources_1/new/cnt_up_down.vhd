...
entity cnt_up_down is
  generic (
    ...
    g_CNT_WIDTH2 : natural := 4 --! Default number of counter bits
  );
  port (
    ...
    cnt2    :out   std_logic_vector(g_CNT_WIDTH2 - 1 downto 0)
  );
...
architecture behavioral of cnt_up_down is
  ...
  signal sig_cnt2 : unsigned(g_CNT_WIDTH2 - 1 downto 0); --! Local counter
begin
